                        ...
                        <div class="card h-100 shadow-sm border-0">
                            <div class="card-body d-flex flex-column">
                                            ...
                                            @if ($session->id == 7)
                                                <div
                                                    ...
                                                    <div class="me-2">
                                                        ...
                                                        {{-- Tajuk Sesi --}}
                                                        <div><i
                                                                class="bx bx-layer me-1 text-success"></i>{{ $session->title ?? 'Sesi' }}
                                                        </div>
                                                        ...
                                                        @if (!empty($session->venue))
                                                            <div class="small text-muted">
                                                                <i
                                                                    class="bx bx-map me-1 text-warning"></i>{{ $session->venue }}
                                                            </div>
                                                        @endif
                                                    </div>
                                ...
                                <div class="mt-auto row g-2">
                                    ...
                                    <div class="col-12 col-sm">
                                        <a href="{{ route('public.program.show', ['program' => $program->id]) }}"
